( function ( $, mw, OO, ve ) {
	...
	mw.sanctions.ve.ui.AgreeInspector.static.title = OO.ui.deferMsg( 'sanctions-ve-agree-days-inspector-title' );
	mw.sanctions.ve.ui.AgreeInspector.static.modelClasses = [ ve.dm.MWTransclusionNode ];

	mw.sanctions.ve.ui.AgreeInspector.static.template = mw.config.get( 'wgSanctionsAgreeTemplate' );
	...
	mw.sanctions.ve.ui.AgreeInspector.prototype.setApplicableStatus = function () {
		...
		if ( templateModel.hasParameter( key ) ) {
			inspector.actions.setAbilities( { done: !!this.expirationInput.getValue() } );
		} else {
	...
	mw.sanctions.ve.ui.AgreeInspector.prototype.initialize = function () {
		...
		// Parent method
		mw.sanctions.ve.ui.AgreeInspector.super.prototype.initialize.apply( this, arguments );
	...
	mw.sanctions.ve.ui.AgreeInspector.prototype.getActionProcess = function ( action ) {
		var deferred, inspector, transclusionModelPlain,
		...
		if ( action === 'done' ) {
			...
			if ( this.expirationInput.getValue() ) {
				...
				deferred.reject( new OO.ui.Error( OO.ui.msg( 'sanctions-ve-agree-days-inspector-invalid-value', inspector.expirationInput.getValue() ) ) );
			}
		...
		// Parent method
		return mw.sanctions.ve.ui.AgreeInspector.super.prototype.getActionProcess.apply( this, arguments );
	};
	 ...
	 */
	mw.sanctions.ve.ui.AgreeInspector.prototype.getSetupProcess = function ( data ) {
		// Parent method
		return mw.sanctions.ve.ui.AgreeInspector.super.prototype.getSetupProcess.apply( this, arguments )
			.next( function () {
	...
	mw.sanctions.ve.ui.AgreeInspector.prototype.getReadyProcess = function () {
		// Parent method
		return mw.sanctions.ve.ui.AgreeInspector.super.prototype.getReadyProcess.apply( this, arguments )
			.next( function () {
	...
	mw.sanctions.ve.ui.AgreeInspector.prototype.getTeardownProcess = function () {
		// Parent method
		return mw.sanctions.ve.ui.AgreeInspector.super.prototype.getTeardownProcess.apply( this, arguments )
			.first( function () {
				// Cleanup
	...
	mw.sanctions.ve.ui.AgreeInspector.prototype.getSelectedNode = function () {
		// Parent method
		var node = mw.sanctions.ve.ui.AgreeInspector.super.prototype.getSelectedNode.apply( this, arguments );
		// Checks the model class
		if ( node && node.isSingleTemplate( mw.sanctions.ve.ui.AgreeInspector.static.template ) ) {
			return node;
		}
